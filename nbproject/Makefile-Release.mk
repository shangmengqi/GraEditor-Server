...
${OBJECTDIR}/Control/CooperControlLayer.o: Control/CooperControlLayer.cpp 
	${MKDIR} -p ${OBJECTDIR}/Control
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IThirdpart/sdbdriver/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Control/CooperControlLayer.o Control/CooperControlLayer.cpp

${OBJECTDIR}/Control/VersionControlLayer.o: Control/VersionControlLayer.cpp 
	${MKDIR} -p ${OBJECTDIR}/Control
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IThirdpart/sdbdriver/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Control/VersionControlLayer.o Control/VersionControlLayer.cpp
...
${OBJECTDIR}/Module/Module.o: Module/Module.cpp 
	${MKDIR} -p ${OBJECTDIR}/Module
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IThirdpart/sdbdriver/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Module/Module.o Module/Module.cpp
...
${OBJECTDIR}/Thirdpart/json11/json11.o: Thirdpart/json11/json11.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IThirdpart/sdbdriver/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Thirdpart/json11/json11.o Thirdpart/json11/json11.cpp
